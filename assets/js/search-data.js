...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Publications",
          description: "Below, you can find my list of publications in reversed chronological order.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Teaching",
          description: "Course syllabus, schedules, and sometimes extra resources for classes taught.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Teachings",handler: () => {
            ...
            },},{id: "teachings-introduction-to-the-mathematical-analysis-of-data",
          title: 'Introduction to the Mathematical Analysis of Data',
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/CV_Jonathan_Chavez_Jan26.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%63%68%61%76%65%7A%63@%75%72%69.%65%64%75", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=6AtacIUAAAAJ", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
